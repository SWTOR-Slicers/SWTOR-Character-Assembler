...
This Blender Addon reproduces the function of the Slicers GUI tool's Locate feature as a Blender button in its 3D Viewer's Sidebar, filling the selected Player Character or NPC's folder (exported by TORCommunity.com's Character Designer and NPC database) with all the game assets required for the .gr2 Importer Addon's Character Import feature to reconstruct them.
